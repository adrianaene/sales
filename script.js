...
myApp.controller('myAppCtrl', function ($scope) {
  ...
  $scope.papers = [{ name : 'Click', category : 'Tabloide', price : 1, book : 28, cd : 10},
    ...
    { name : 'Gazeta Sporturilor', category : 'Sport', price : 3, book : 15, cd : 10},
    ...
    { name : 'OK! Romania', category : 'Celebritati', price : 10, book : 11, cd : 10},
    { name : 'Ciao!', category : 'Vedete', price : 12, book : 10, cd : 10},
    ...
    { name : 'Super Bravo Girl', category : 'Reviste pentru adolescenti', price : 2, book : 6, cd : 10},
    { name : 'ELLE', category : 'Femei (Lifestyle / moda)', price : 4, book : 5, cd : 10},
    { name : 'Ioana', category : 'Femei', price : 1, book : 4, cd : 10},
    { name : 'Historia', category : 'Cultura', price : 7, book : 4, cd : 10},
    { name : 'Evenimentul Zilei', category : 'Cotidian generalist national', price : 2, book : 14, cd : 12},
    { name : 'Viva', category : 'Celebritati', price : 1, book : 4, cd : 13},
    { name : 'Weekend Magazin', category : 'Divertisment, Integrame, Rebus si Jocuri', price : 3, book : 24, cd : 14},
    { name : 'Avantaje', category : 'Femei (Glossy)', price : 1, book : 30, cd : 15},
    { name : 'Romania Libera', category : 'Cotidian generalist national', price : 5, book : 13, cd : 16},
    { name : 'Spy', category : 'Vedete', price : 10, book : 12, cd : 17},
    { name : 'Bihari Naplo', category : 'Cotidian generalist, local sau regional', price : 1, book : 4, cd : 18},
    { name : 'Unica', category : 'Femei (Glossy)', price : 11, book : 16, cd : 109}];
