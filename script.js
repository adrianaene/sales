...
myApp.controller('myAppCtrl', function ($scope) {
  ...
  $scope.papers = [{ name : 'Click', category : 'Tabloide', price : 1, book : 28, cd : 10, hasCD : true, hasBook : true},
    ...
    { name : 'Click SANATATE', category : 'Sanatate', price : 2, book : 18, cd : 10, hasCD : true, hasBook : false},
    { name : 'Plafar', category : 'Sanatate', price : 2, book : 18, cd : 10, hasCD : true, hasBook : true},
    { name : 'Libertatea pentru femei - Retete', category : 'Culinar', price : 1, book : 17, cd : 10, hasCD : true, hasBook : true},
    { name : 'Sanatatea de azi', category : 'Sanatate', price : 1, book : 16, cd : 10, hasCD : false, hasBook : true},
    { name : 'Gazeta Sporturilor', category : 'Sport', price : 3, book : 15, cd : 10, hasCD : false, hasBook : true},
    { name : 'Gazeta Sporturilor de Duminica', category : 'Sport', price : 3, book : 15, cd : 10, hasCD : true, hasBook : true},
    ...
    { name : 'Evenimentul Zilei', category : 'Cotidian generalist', price : 2, book : 14, cd : 12, hasCD : true, hasBook : false},
    { name : 'Viva', category : 'Vedete', price : 1, book : 4, cd : 13, hasCD : false, hasBook : false},
    { name : 'Weekend Magazin', category : 'Divertisment', price : 3, book : 24, cd : 14, hasCD : false, hasBook : false},
    { name : 'Avantaje', category : 'Femei (Glossy)', price : 1, book : 30, cd : 15, hasCD : true, hasBook : false},
    { name : 'Romania Libera', category : 'Cotidian generalist', price : 5, book : 13, cd : 16, hasCD : true, hasBook : false},
    { name : 'Spy', category : 'Vedete', price : 10, book : 12, cd : 17, hasCD : true, hasBook : true},
    { name : 'Bihari Naplo', category : 'Cotidian generalist', price : 1, book : 4, cd : 18, hasCD : false, hasBook : true},
